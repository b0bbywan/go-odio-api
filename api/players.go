...
func withPlayer(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if len(capFieldNames) > 0 {
			hasCapability, capabilityName := mpris.CheckCapabilities(player, capFieldNames...)
			if !hasCapability {
