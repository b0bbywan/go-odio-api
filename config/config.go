...
// self` in config, tab being the default. It stays empty without a URL, there
// being nothing to open.
type OpenMode string

const (
	OpenTab   OpenMode = "tab"
...
func New(cfgFile *string) (*Config, error) {
	...
	if isUnixSocket(uiCfg.Admin) {
		logger.Warn("[config] api.ui.admin %q is a Unix socket, ignored: use api.ui.adminSocket", uiCfg.Admin)
		uiCfg.Admin = ""
	}
